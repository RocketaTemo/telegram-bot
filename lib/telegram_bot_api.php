...
class TelegramBotApi{
	...
	public $chatId = null; //also userId
	public $messageId = null;
	public $adminChatId = "-1001160009464";
	public $debug = true;
	public $proxy = "";
	...
	public function getWebhookUpdate(){
		...
		elseif(isset( $body["message"]["media_group_id"]["photo"])){
			$this->media_group_id = $body["message"]["media_group_id"];
			$this->photo = $body["message"]["photo"];
		}
	...
	//Отправляет альбома в чат
	public function sendMediaGroup( $params ){
		if( !isset( $params['chat_id'] ) && isset( $this->adminChatId ) ){
	...
	public function sendPhoto( $params, $caption = null ){
		...
		if( !isset( $params['chat_id'] ) && isset( $this->chatId ) ){
			$params['chat_id'] = $this->chatId;//chat_id admina ~("-1001160009464"  !$this->chatId) 
		}
	...
	//Перессылка сообщения из чата в чат 
